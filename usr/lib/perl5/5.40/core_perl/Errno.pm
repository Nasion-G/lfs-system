...
"x86_64\-linux\-thread-6\.11\.4\-arch2\-1" or
	die "Errno architecture (x86_64\-linux\-thread-6\.11\.4\-arch2\-1) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
